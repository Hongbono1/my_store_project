...
export async function uploadManagerAd(req, res) {
  ...
  try {
    ...
    console.error("uploadManagerAd (index) ERROR:", err);
...
export async function saveTextSlot(req, res) {
  ...
  try {
    ...
    console.error("saveTextSlot (index) ERROR:", err);
    return res.status(500).json({
      ok: false,
...
export async function getSlot(req, res) {
  ...
  try {
    ...
    console.error("getSlot (index) ERROR:", err);
    return res.status(500).json({
      ok: false,
...
export async function getTextSlot(req, res) {
  ...
  try {
    ...
    console.error("getTextSlot (index) ERROR:", err);
    return res.status(500).json({
      ok: false,
